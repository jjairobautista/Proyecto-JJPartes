...
<div class="container ">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" style="border-right: 1px solid #bbb;" href="Navega.php">Navega</a>
                        </li>
                        <li class="nav-item">
    ...
    <footer>
        <div class="row bg-black" id="footerr">
            <div class="col">
                <form action="../control/controladorUser.php?a=correo&" method="post">
                    <div class="mb-2"><br>
                        ...
                        <br>
                        <a class="btn btn-primary" type="submit"  id="btnEnviarConsulta">Enviar Pregunta</a>
                        <br>
                    </div>
                </form>
            ...
            <div class="col"><br><br><br><br><br><img src="../img/LOGOBLACK.jpg" width="400px" height="200px"
